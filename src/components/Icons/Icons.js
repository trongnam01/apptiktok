...
export const UploadIcons = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const IconsMesseger = ({ width = '3.2rem', height = '3.2rem', className, classe }) => {
    return (
        <div className={cx('messeger')}>
            <svg
                className={className}
                width={width}
                height={height}
                viewBox="0 0 32 32"
                //fill = "currentColor" custom css
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
            >
                <path
            ...
            <span className={cx('quantity')}>13</span>
        </div>
    );
};
